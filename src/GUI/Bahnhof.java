...
public class Bahnhof extends Field{
	...
	private void karteErstellen() {
 	...
 	//	picpanel.setBackground(Color.green);
 		...
 		streetname.setIcon(new ImageIcon(new ImageIcon("images/Zug0.png").getImage().getScaledInstance((int) (width*0.8), (int) (height*0.5*0.8), Image.SCALE_DEFAULT)));
 		...
 		if (position < 10) {
 			zug.setIcon(new ImageIcon(new ImageIcon("images/Zug0.png").getImage().getScaledInstance((int) (width*0.8), (int) (height*0.5*0.8), Image.SCALE_DEFAULT)));

 		} else if (position < 20) {
 			zug.setIcon(new ImageIcon(new ImageIcon("images/Zug90.png").getImage().getScaledInstance((int) (height*0.5*0.8), (int) (width*0.8), Image.SCALE_DEFAULT)));

 		} else if (position < 30) {
 			zug.setIcon(new ImageIcon(new ImageIcon("images/Zug180.png").getImage().getScaledInstance((int) (width*0.8), (int) (height*0.5*0.8), Image.SCALE_DEFAULT)));

 		} else {
 			zug.setIcon(new ImageIcon(new ImageIcon("images/Zug270.png").getImage().getScaledInstance((int) (height*0.5*0.8), (int) (width*0.8), Image.SCALE_DEFAULT)));

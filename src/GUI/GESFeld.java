...
public class GESFeld extends Field {
	...
	private void erstelleKarte() {
		...
		if (name.contains("Gemein")) {
			text.setIcon(new ImageIcon(new ImageIcon("images/Schatztruhe.png").getImage()
					.getScaledInstance((int) (0.75 * width), (int) (0.75 * width), Image.SCALE_DEFAULT)));
		} else if (name.contains("eignis")) {
			text.setIcon(new ImageIcon(new ImageIcon("images/fragezeichen.png").getImage()
					.getScaledInstance((int) (0.75 * width), (int) (0.75 * width), Image.SCALE_DEFAULT)));
		} else if (name.contains("usatz")) {
			text.setIcon(new ImageIcon(new ImageIcon("images/Ring.png").getImage()

...
public class EndScreen extends JFrame implements MouseListener {
	...
	private void createFrame() {
		...
		podium1 = new JLabel();
		podium1.setBounds(304, 171, 160, 140);
		podium1.setText("#1");
		...
		podium1.setBorder(BorderFactory.createMatteBorder(5, 0, 0, 0, new Color(238, 203, 4)));
		
		this.add(podium1);

		podium2 = new JLabel();
		podium2.setBounds(464, 211, 160, 100);
		podium2.setText("#2");
		...
		podium2.setBorder(BorderFactory.createMatteBorder(5, 0, 0, 0, new Color(238, 203, 4)));
		this.add(podium2);

		podium3 = new JLabel();
		podium3.setBounds(144, 251, 160, 60);
		podium3.setText("#3");
		...
		podium3.setBorder(BorderFactory.createMatteBorder(5, 0, 0, 0, new Color(238, 203, 4)));
		this.add(podium3);

		// Spielerschriftzuege auf dem Podium
		spielerAnzeige1 = new JLabel();
		spielerAnzeige1.setBounds(304, 131, 160, 40);
		...
		spielerAnzeige2.setBounds(464, 176, 160, 40);
		...
		spielerAnzeige3.setBounds(144, 216, 160, 40);
		...
		geldAnzeige1.setBounds(304, 106, 160, 40);
		...
		geldAnzeige2.setBounds(464, 156, 160, 40);
		...
		geldAnzeige3.setBounds(144, 196, 160, 40);
		...
		spielerAnzeige4.setBounds(144, 310, 480, 55);
		spielerAnzeige4.setText("#4: Spieler 4, DM 30000");
		spielerAnzeige4.setBackground(new Color(46, 51, 75));
		spielerAnzeige4.setForeground(new Color(238, 203, 4));
		spielerAnzeige4.setBorder(BorderFactory.createMatteBorder(2, 0, 0, 0, new Color(238, 203, 4)));
		spielerAnzeige4.setOpaque(true);
		...
		// Buttons
		neues = new JButton();
		neues.setBounds(219, 395, 160, 40);
		...
		beenden = new JButton();
		beenden.setBounds(389, 395, 160, 40);
	...
	public void endAnzeige(int[][] i) {
		...
		spielerAnzeige4.setText("#4: Spieler " + i[3][0] + ", DM " + i[3][1]);

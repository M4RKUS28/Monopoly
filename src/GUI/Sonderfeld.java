...
public class Sonderfeld extends Field{
	...
	private void createLos() {
		...
		arrow.setIcon(new ImageIcon(new ImageIcon("images/Pfeil.png").getImage().getScaledInstance((int) (size*0.8), (int) ((size*0.22)*0.8), Image.SCALE_DEFAULT)));
...
*/
		JLabelR gefaengnis = new JLabelR("Gefängnis", 45);
		im.setForeground(Color.black);
		im.setFont(new Font("Arial", Font.BOLD, 16));
	//
	...
	private void createFreiParken() {
		...
		JLabel picture = new JLabel();
		picture.setIcon(new ImageIcon(new ImageIcon("images/FreiParken.png").getImage().getScaledInstance((int) (size*1), (int) ((size*0.93)*1), Image.SCALE_DEFAULT)));
		picture.setHorizontalAlignment(SwingConstants.CENTER);
		picture.setVerticalAlignment(SwingConstants.CENTER);
	...
	private void createGehInsGefaengnis() {
		...
		JLabel picture = new JLabel();
		picture.setIcon(new ImageIcon(new ImageIcon("images/Polizist.png").getImage().getScaledInstance((int) (size*0.7), (int) ((size*0.98)*0.7), Image.SCALE_DEFAULT)));
		picture.setHorizontalAlignment(SwingConstants.CENTER);
		picture.setVerticalAlignment(SwingConstants.CENTER);
